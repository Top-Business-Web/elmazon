    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img mobile-icon" alt="logo">
                <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
        ...
        <div class="d-flex order-lg-2 mr-auto">
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                    <div class="message-menu">
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="<?php echo e(asset('assets/admin')); ?>/images/users/1.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="<?php echo e(asset('assets/admin')); ?>/images/users/12.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="<?php echo e(asset('assets/admin')); ?>/images/users/4.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="<?php echo e(asset('assets/admin')); ?>/images/users/15.jpg"></span>
                            <div>
            ...
            <div class="dropdown d-md-flex country-selector">
                <a href="#" class="d-flex nav-link icon leading-none" data-toggle="dropdown" aria-expanded="true">
                    <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/us_flag.jpg" alt="img" class="mr-2 align-self-center">
                    <div>
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/french_flag.jpg" alt="flag-img" class="avatar  mr-3 align-self-center">
                        <div>
                            <strong>French</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/germany_flag.jpg" alt="flag-img" class="avatar  mr-3 align-self-center">
                        <div>
                            <strong>Germany</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/italy_flag.jpg" alt="flag-img" class="avatar  mr-3 align-self-center">
                        <div>
                            <strong>Italy</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/russia_flag.jpg" alt="flag-img" class="avatar  mr-3 align-self-center">
                        <div>
                            <strong>Russia</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="<?php echo e(asset('assets/admin')); ?>/images/flags/spain_flag.jpg" alt="flag-img" class="avatar  mr-3 align-self-center">
                        <div>
                            <strong>Spain</strong>
                        </div>
                    </a>
...
<?php /**PATH C:\laragon\www\students\resources\views/admin/layouts_admin/main-header.blade.php ENDPATH**/ ?>