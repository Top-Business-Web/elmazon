...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        showData('<?php echo e(route('audio.index')); ?>', columns);
        // Delete Using Ajax
        destroyScript('<?php echo e(route('audio.destroy',':id')); ?>');
        // Add Using Ajax
        showAddModal('<?php echo e(route('audio.create')); ?>');
        addScript();
        // Add Using Ajax
        showEditModal('<?php echo e(route('audio.edit',':id')); ?>');
        editScript();
    </script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('Admin/layouts_admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\students\resources\views/admin/audios/index.blade.php ENDPATH**/ ?>