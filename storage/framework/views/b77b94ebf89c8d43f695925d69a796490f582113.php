...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        showData('<?php echo e(route('seasons.index')); ?>', columns);
        // Delete Using Ajax
        destroyScript('<?php echo e(route('seasons.destroy',':id')); ?>');
        // Add Using Ajax
        showAddModal('<?php echo e(route('seasons.create')); ?>');
        addScript();
        // Add Using Ajax
        showEditModal('<?php echo e(route('seasons.edit',':id')); ?>');
        editScript();
    </script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('Admin/layouts_admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\students\resources\views/admin/seasons/index.blade.php ENDPATH**/ ?>