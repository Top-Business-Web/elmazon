    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('seasons.index')); ?>">
                ...
                <span class="side-menu__label"><?php echo e(trans('admin.seasons')); ?></span>
            </a>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('subjectsClasses.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
                <span class="side-menu__label"><?php echo e(trans('admin.subject_class')); ?></span>
            </a>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('terms.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
                <span class="side-menu__label"><?php echo e(trans('admin.term')); ?></span>
            </a>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('lessons.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
                <span class="side-menu__label"><?php echo e(trans('admin.lesson')); ?></span>
            </a>
        </li>
...
<?php /**PATH C:\laragon\www\students\resources\views/admin/layouts_admin/main-sidebar.blade.php ENDPATH**/ ?>