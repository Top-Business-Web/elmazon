...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        // Delete Using Ajax
        destroyScript('<?php echo e(route('lessons.destroy',':id')); ?>');
        // Add Using Ajax
        showAddModal('<?php echo e(route('lessons.create')); ?>');
        addScript();
        // Add Using Ajax
        showEditModal('<?php echo e(route('lessons.edit',':id')); ?>');
        editScript();
    </script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('Admin/layouts_admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\students\resources\views/admin/lessons/index.blade.php ENDPATH**/ ?>