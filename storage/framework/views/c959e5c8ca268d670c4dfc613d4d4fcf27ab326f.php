...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        showData('<?php echo e(route('videosParts.index')); ?>', columns);
        // Delete Using Ajax
        destroyScript('<?php echo e(route('videosParts.destroy',':id')); ?>');
        // Add Using Ajax
        showAddModal('<?php echo e(route('videosParts.create')); ?>');
        addScript();
        // Add Using Ajax
        showEditModal('<?php echo e(route('videosParts.edit',':id')); ?>');
        editScript();
    </script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('Admin/layouts_admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\students\resources\views/admin/videoparts/index.blade.php ENDPATH**/ ?>