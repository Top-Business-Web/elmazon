...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        showData('<?php echo e(route('terms.index')); ?>', columns);
        // Delete Using Ajax
        destroyScript('<?php echo e(route('terms.destroy',':id')); ?>');
        // Add Using Ajax
        showAddModal('<?php echo e(route('terms.create')); ?>');
        addScript();
        // Add Using Ajax
...
<?php echo $__env->make('Admin/layouts_admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\students\resources\views/admin/terms/index.blade.php ENDPATH**/ ?>