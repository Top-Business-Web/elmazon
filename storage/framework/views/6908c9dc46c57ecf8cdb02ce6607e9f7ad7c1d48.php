...
<aside class="app-sidebar">
    <div class="side-header">
        <a class="header-brand1" href="#">
            <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img desktop-logo"
                alt="logo">
            <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img toggle-logo"
                alt="logo">
            <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img light-logo"
                alt="logo">
            <img src="<?php echo e(asset('assets/admin/images/logo-mazon.png')); ?>" class="header-brand-img light-logo1"
                alt="logo">
        </a>
        <!-- LOGO -->
    </div>
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('seasons.index')); ?>">
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('subjectsClasses.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('terms.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('lessons.index')); ?>">
                <i class="fe fe-git-commit side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('videosParts.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('monthlyPlans.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('suggestions.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('onlineExam.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('phoneCommunications.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('slider.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('section.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('questions.index')); ?>">
                <i class="icon icon-handbag side-menu__icon"></i>
        ...
        <li class="slide">
            <a class="side-menu__item" href="<?php echo e(route('countries.index')); ?>">
                <i class="fe fe-tag side-menu__icon"></i>
                <span class="side-menu__label"><?php echo e(trans('admin.countries')); ?></span>
            </a>
        </li>
...
<?php /**PATH C:\laragon\www\elmazon\resources\views/admin/layouts_admin/main-sidebar.blade.php ENDPATH**/ ?>