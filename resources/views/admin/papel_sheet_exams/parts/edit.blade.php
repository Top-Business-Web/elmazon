        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control" name="degree" value="{{ $papelSheetExam->degree }}" style="text-align: center">
                    </Select>
                </div>
                <div class="col-md-4" style="    position: absolute;
    right: 500px;">
                    <label for="date_exam" class="form-control-label">وقت الامتحان</label>
                    <input type="date" class="form-control" name="date_exam" value="{{ $papelSheetExam->date_exam }}" style="text-align: center">
                    </Select>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="name_ar" value="{{ $papelSheetExam->name_ar }}" style="text-align: center">
                </div>
                <div class="col-md-6">
                    <label for="name_en" class="form-control-label">الاسم بالانجليزية</label>
                    <input type="text" class="form-control" value="{{ $papelSheetExam->name_en }}" name="name_en" style="text-align: center">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" value="{{ $papelSheetExam->from }}" name="from" style="text-align: center">
                </div>
                <div class="col-md-6">
                    <label for="name_en" class="form-control-label">الى</label>
                    <input type="date" class="form-control" value="{{ $papelSheetExam->to }}" name="to" style="text-align: center">
                    </Select>
                </div>
            </div>
            <div class="row">
