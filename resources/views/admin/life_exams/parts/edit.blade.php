        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" style="text-align: center" value="{{ $lifeExam->name_ar}}" class="form-control" name="name_ar">
                </div>
                <div class="col-md-6">
                    <label for="name_en" class="form-control-label">الاسم بالانجليزية</label>
                    <input type="text" style="text-align: center" value="{{ $lifeExam->name_en}}" class="form-control" name="name_en">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <label for="date_exam" class="form-control-label">موعد الامتحان</label>
                    <input type="date" style="text-align: center" value="{{ $lifeExam->date_exam}}" class="form-control" name="date_exam">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <label for="time_start" class="form-control-label">موعد البدء</label>
                    <input type="time" style="text-align: center" value="{{ $lifeExam->time_start}}" class="form-control" name="time_start">
                </div>
                <div class="col-md-6">
                    <label for="time_end" class="form-control-label">موعجد النهاية</label>
                    <input type="time" style="text-align: center" value="{{ $lifeExam->time_end}}" class="form-control" name="time_end">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="number" style="text-align: center" value="{{ $lifeExam->quiz_minute}}" class="form-control" name="quiz_minute">
                </div>
                <div class="col-md-4">
                    <label for="time_end" class="form-control-label">محاولات</label>
                    <input type="number" style="text-align: center" value="1" readonly class="form-control" name="trying">
                </div>
                <div class="col-md-4">
                    <label for="time_end" class="form-control-label">الدرجة</label>
                    <input type="number" style="text-align: center" value="{{ $lifeExam->degree}}" class="form-control" name="degree">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
