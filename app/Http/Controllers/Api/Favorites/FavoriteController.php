...
class FavoriteController extends Controller
{
    ...
    final public function getAllExamFavorites(): array
    {
        ...
        foreach ($exam_favorites as $exam_favorite){
            ...
            $examData['answer_video_file'] = $exam_favorite->online_exam_name != null  ?  asset('online_exams/videos_answers/'. $exam_favorite->online_exam_answer_video_file) :  ($exam_favorite->all_exam_name != null  ?  asset('all_exams/videos_answers/'. $exam_favorite->all_exam_answer_video_file) : asset('live_exam_file_uploads/videos/'. $exam_favorite->life_exam_answer_video_file));
