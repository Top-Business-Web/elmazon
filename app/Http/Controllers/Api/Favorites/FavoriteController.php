...
class FavoriteController extends Controller{
    ...
    public function examAddFavorite(Request $request): JsonResponse{
        ...
        try {
            ...
            if ($validator->fails()) {
                ...
                if (is_numeric($errors)) {
                    ...
                    $errors_arr = [
                        ...
                        409 => 'Failed,Action must be an favorite or un_favorite',
                    ];
            ...
            if($request->online_exam_id == null && $request->all_exam_id == null){

                return self::returnResponseDataApi(null, "يجب اختيار امتحان اونلاين او شامل للمفضله", 420);
                ...
                if($request->online_exam_id !=null){
                    ...
                    if($userFavorite){
                        ...
                        $favorite = ExamsFavorite::query()
                            ...
                            ->where('online_exam_id','=',$request->online_exam_id)->first();
                        ...
                        return self::returnResponseDataApi(null,$request->action == 'favorite' ? "تم اضافه الامتحان للمفضله" :  "تم حذف الامتحان من المفضله", 200);
                        ...
                        return self::returnResponseDataApi(null,"تم اضافه الامتحان للمفضله", 200);
                    ...
                    if($userFavorite){
                        ...
                        $favorite = ExamsFavorite::query()
                            ->where('user_id','=',Auth::guard('user-api')->id())
                            ->where('all_exam_id','=',$request->all_exam_id)->first();
            ...
            if($request->video_basic_id == null && $request->video_resource_id == null && $request->video_part_id == null){
                ...
                if($request->video_basic_id !=null){
                    ...
                    if($userVideoFavorite){
                        ...
                        $favorite_add = VideoFavorite::query()
                            ->where('user_id','=',Auth::guard('user-api')->id())
                            ->where('video_basic_id','=',$request->video_basic_id)->first();
                ...
                elseif ($request->video_resource_id !=null){
                    ...
                    if($userVideoFavorite){
                        ...
                        $favorite_add = VideoFavorite::query()
                            ->where('user_id','=',Auth::guard('user-api')->id())
                            ->where('video_resource_id','=',$request->video_resource_id)->first();
                    ...
                    if($userVideoFavorite){
                        ...
                        $favorite_add = VideoFavorite::query()
                            ->where('user_id','=',Auth::guard('user-api')->id())
                            ->where('video_part_id','=',$request->video_part_id)->first();
