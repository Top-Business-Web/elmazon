...
class FavoriteController extends Controller
{
    ...
    final public function getAllExamFavorites(): array
    {
        ...
        foreach ($exam_favorites as $exam_favorite){
            ...
            $examData['answer_video_is_youtube'] = $exam_favorite->online_exam_nam != null ?  $exam_favorite->answer_video_is_youtube : $exam_favorite->answer_video_is_youtube_all_exam;
