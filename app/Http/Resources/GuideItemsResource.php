...
class GuideItemsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'file_time' => $this->file_type == 'video' ? video_duration(asset($this->file)) : "" ,
            ...
            'answer_video_file_time' => $this->answer_video_file != null ? video_duration(asset($this->answer_video_file)) : "0" ,
